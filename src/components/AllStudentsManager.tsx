  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h2 className="text-3xl font-black text-slate-900 tracking-tight">সকল ছাত্র (আর্কাইভ সহ)</h2>
          <p className="text-slate-500 font-bold mt-1">মাদরাসার শুরু থেকে বর্তমান পর্যন্ত সকল ছাত্রের তালিকা</p>
        </div>
      </div>
